...
public enum SuccessStatus implements BaseCode {
    ...
    USER_KAKAO_LOGOUT_OK(HttpStatus.OK, "AUTH2002", "회원 카카오 로그아웃이 완료되었습니다."),
    USER_NAVER_LOGIN_OK(HttpStatus.OK, "AUTH2003", "회원 네이버 로그인이 완료되었습니다."),
    ...
    RECIPE_SEARCH_OK(HttpStatus.OK, "RECIPE_6006", "레시피 검색 성공"),
    ...
    RECIPE_REMAINING_OK(HttpStatus.OK, "RECIPE_6005", "남은 재료로 뚝딱 한끼 조회 성공"),
